...
export function AppReleaseNotesPrompt() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(var(--sakuin-mobile-nav-height)+0.75rem)] z-[270] px-4 lg:bottom-5 lg:left-auto lg:right-5 lg:max-w-sm lg:px-0">
      <section className="overflow-hidden rounded-3xl border border-black/10 bg-white shadow-[0_24px_70px_rgba(0,0,0,0.16)]">
        ...
        <div className="p-4">
          <div className="flex items-start gap-3">
            ...
            <button
              ...
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-zinc-100 text-zinc-500 transition hover:bg-zinc-200 hover:text-black"
              onClick={dismiss}
              type="button"
            >
              <X className="h-4 w-4" />
          ...
          <button
            className="mt-4 inline-flex min-h-10 w-full items-center justify-center rounded-2xl bg-black px-4 text-xs font-black text-white transition hover:bg-zinc-800"
            onClick={dismiss}
            type="button"
          >
            Mengerti
