  ...
  return (
    <section className="rounded-3xl border border-[var(--sakuin-border)] bg-white p-4 shadow-sm sm:p-5">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-sm font-black text-[var(--sakuin-text)]">Aplikasi Sakuin</p>
      ...
      <div className="mt-4 grid gap-3">
        ...
        <div className="grid gap-2">
          <InstallAppButton
            ...
            variant="compact"
            className="inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-[var(--sakuin-secondary)] px-4 text-sm font-black text-white shadow-sm transition hover:bg-[var(--sakuin-secondary)]"
          />
        ...
        <div className="rounded-2xl border border-[var(--sakuin-border)] bg-[var(--sakuin-primary-soft)] p-3">
          <p className="text-[10px] font-black uppercase text-zinc-500">
            Update terbaru
          </p>
          <p className="mt-1 text-sm font-black text-[var(--sakuin-text)]">
          ...
          <ul className="mt-3 grid gap-1.5">
            {SAKUIN_RELEASE_NOTES.slice(0, 2).map((note) => (
              <li
                ...
                key={note}
              >
                <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-[var(--sakuin-secondary)]" />
                <span>{note}</span>
              </li>
            ))}
          </ul>
