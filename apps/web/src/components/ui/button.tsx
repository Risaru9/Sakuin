...
export const buttonClassName = ({
  ...
  const variantClassName: Record<ButtonVariant, string> = {
    primary:
      "bg-[var(--sakuin-primary)] text-white shadow-sm hover:bg-[var(--sakuin-secondary)] focus-visible:ring-[var(--sakuin-focus)]",
    secondary:
      "border border-[var(--sakuin-border)] bg-white text-[var(--sakuin-text)] shadow-sm hover:bg-[var(--sakuin-primary-soft)] focus-visible:ring-[var(--sakuin-focus)]",
    ghost:
      "bg-transparent text-[var(--sakuin-muted)] hover:bg-[var(--sakuin-primary-soft)] hover:text-[var(--sakuin-text)] focus-visible:ring-[var(--sakuin-focus)]",
    danger:
