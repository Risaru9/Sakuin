...
vi.mock("../src/modules/accounts/account.service.js", () => ({ resolveOwnedAccountId: vi.fn(async () => "account") }));
import { createTransactionsBulk } from "../src/modules/transactions/transaction.service.js";
const saved = { id: "saved", type: "EXPENSE", amount: 18000, note: "kopi", date: new Date(), createdAt: new Date(), updatedAt: new Date(), account: null, category: { id: "food", name: "Makanan", type: "EXPENSE", icon: null, color: null, isDefault: true } };
